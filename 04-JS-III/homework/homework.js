...
function mesesDelAño(array) {
  ...
  meses3=[]
  for(i=0 ; i<array.length ; i++){
  if (array[i] === "Marzo"||array[i] ===  "Noviembre" ||array[i] === "Enero"){meses3.push(array[i])}
  }
...
if(numeroN===10){return "Se interrumpió la ejecución"}
else {return array}
}
